 ...
 *
 *          Stage 6 (2026-05-05): PE9 PWM 频率 100 Hz → 15 kHz.
 *            实现: TIM6 软件 PWM → TIM1_CH1 硬件 PWM (full remap, PE9).
 *            原因: 100 Hz 在人耳可闻, 婴儿患者可听见. 15 kHz 远超机械共振 + 业界医疗标准.
 *            分辨率: 100 步 (0~100% with 1% 颗粒度). API 兼容旧实现, 无外部调用变化.
 */
