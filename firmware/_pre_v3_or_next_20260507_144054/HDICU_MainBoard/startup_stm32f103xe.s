 ...
 * @brief   Minimal startup for STM32F103xE (Cortex-M3)
 * @note    This is a minimal startup file. For production, use the official
 *          startup file from STM32CubeF1 package:
 *          Drivers/CMSIS/Device/ST/STM32F1xx/Source/Templates/gcc/startup_stm32f103xe.s
 *
 *          Vector table entries match STM32F103VET6 (high-density device).
 */
...
/* Start address for .data from linker script */
.word _sidata
.word _sdata
.word _edata
.word _sbss
...
LoopFillZerobss:
  ...
  /* Call SystemInit (weak, may be empty) */
  bl SystemInit
...
/**
 * @brief Vector table — placed at 0x08000000 by linker
 */
