 ...
 * Stage 8 (2026-05-06): 26 → 39 字节
 *   byte 0-25:  v2.1 现有字段 (实时值/状态/报警)
 *   byte 26-37: setpoint 字段 (target_temp/humid/o2/co2/fog_time/disinfect_time, 各 2 字节)
 *   byte 38:    高 4 bit = protocol_version (Stage 8 = 0x1)
 *               低 4 bit = enable bitmap (bit0 temp / bit1 humid / bit2 o2)
 * 屏幕板兼容性: len < 26 解析失败; 26 <= len < 38 旧主板, 不 seed setpoint;
 *               len >= 38 新主板, 完整 seed. */
#define SCR_DISPLAY_DATA_LEN        39
